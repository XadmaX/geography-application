var data = [
  {
    question:
      'Which planet having all the circumstances for the existence of life?',
...
let result = (user, pswd, data) => {
  db.auth(user, pswd), db.questions.insertMany(data);
};
console.log(result(user, pswd, data));
